...
[Tank]0..1 - 0..*[Fish]
[Fish]0..* - 1..*[Fish]'''
a5 = '''[Tank|number {PK};name;volume;color]
...
def mark_answer(qid, answer):
    ...
    marking_code = get_marking_code(qid)
    ...
    exec(result, args)
    return args["___results___"]


print(mark_answer(1, a5))
